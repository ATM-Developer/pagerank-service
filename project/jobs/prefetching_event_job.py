...
class PrefetchingEvents():
    ...
    def get(self):
        try:
            ...
            to_block = self.web3eth.get_last_block_number(app_config.INCENTIVE_ADDRESS, INCENTIVE_ABI) - 36
...
logger.info('get prefetching events Job Is Running, pid:{}'.format(os.getpid()))
